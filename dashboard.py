...
@st.cache_data
def load_data():
    df = pd.read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vSqX2UIjXuKu7noH2QLT8k-YfNbWtJgmPbYuaunoOdy51UVtT4IQqvl-fhT0XtxTbe66FE1savHnNVv/pub?gid=286064860&single=true&output=csv")
    ...
    cols_to_num = ['Total Dials', 'Conversations', 'Leads', 'Offer Made', 'Total Correct Numbers',
                   ...
                   'Wrong Number', 'OFFER SCHEDULED', 'OFFER SIGNED', 'CONTRACT SIGNED']
